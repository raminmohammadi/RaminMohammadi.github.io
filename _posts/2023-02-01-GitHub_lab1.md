...
This lab focuses on 5 modules, which includes creating a virtual environment, creating a GitHub repository, creating Python files, creating test files using pytest and unittest, and implementing GitHub Actions.[GitHub link]([https://github.com/raminmohammadi/MLOps/blob/main/Github_Labs/Lab1/src/calculator.py](https://github.com/raminmohammadi/MLOps/tree/main/Github_Labs/Lab1))
...
- To view the code and gain a deeper understanding, please refer to the calculator.py file located under the src folder in this [link](https://github.com/raminmohammadi/MLOps/blob/main/Github_Labs/Lab1/src/calculator.py).
