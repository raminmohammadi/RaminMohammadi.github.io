...
- Copy-paste the [pytest_action.yml](https://github.com/raminmohammadi/MLOps/blob/main/Github_Labs/Lab1/workflows/pytest_action.yml) and [unittest_action.yml](https://github.com/raminmohammadi/MLOps/blob/main/Github_Labs/Lab1/workflows/unittest_action.yml) files into the **.github/workflows** folder.
