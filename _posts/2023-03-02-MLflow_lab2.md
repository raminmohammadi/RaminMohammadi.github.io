...
> [GitHub link](https://github.com/raminmohammadi/MLOps/tree/main/Mlflow_Labs/Lab2)
...
4. Create a **requirements.txt** file and add packages similar to [this](https://github.com/raminmohammadi/MLOps/blob/main/HyperOpt_Labs/requirements.txt).
